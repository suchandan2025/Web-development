...
<section class="container" aria-label="Global Offices and Contact Form" id="contact">
    <div class="left" role="region" aria-labelledby="section-title-offices">
        ...
        <div class="office-entry" aria-label="India office contact details">
            <strong><img class="flag-icon" src="{{ asset('assets/images/indian-flag.png') }}"
                    alt="India flag icon">India</strong>
            <p>1701, 17th Floor, Aurora Waterfront, GN 34/1, beside IEM Ashram Building, GN Block, Sector V,
                Bidhannagar, Kolkata, West Bengal 700091</p>
            <a href="tel:+98624 76791" class="phone">(+91) 98624 76791</a>
        </div>
        <div class="divider" aria-hidden="true"></div>
        ...
        <div class="worktime" aria-label="Official work time">
            <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24">
                <path
                    d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-19a9 9 0 1 0 0 18 9 9 0 0 0 0-18zm.5 4v6.25l4.75 2.85-.75 1.23-5.5-3.3V7h1.5z" />
            </svg>
    ...
    <form class="right" aria-label="Leave a message form" action="#" method="POST" novalidate>
        ...
        <div class="form-group">
            ...
            <div class="input-icon" style="flex:1 1 48%;">
                <input id="phone" name="phone" type="text" placeholder="Phone Number" aria-label="Phone number"
                    autocomplete="tel" />
                <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24">
                    <path
                        d="M6.62 10.79a15.09 15.09 0 006.59 6.59l2.2-2.2a1 1 0 011.09-.21 11.36 11.36 0 003.55.57 1 1 0 011 1v3.25a1 1 0 01-1 1A16 16 0 013 5a1 1 0 011-1h3.25a1 1 0 011 1 11.36 11.36 0 00.57 3.55 1 1 0 01-.21 1.09l-2.2 2.2z" />
                </svg>
            </div>
