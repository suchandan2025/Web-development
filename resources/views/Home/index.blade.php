...
.tech-carousel-track img {
  height: 80px;
  width: 100px; /* ✅ Fixed width ensures seamless loop */
  flex-shrink: 0;
  margin-right: 2rem;
  ...
  <section id="about-us" aria-label="About Xeroic - Innovation & Technology Transforming Brands">
    <div class="row gx-5">
      <div class="col-md-5 image-wrapper" aria-hidden="true">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/836f4fc2-ee07-4cc2-afa9-03829d7c0069.png" alt="Professional woman focused on digital interface, working late" loading="lazy" />
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/1fae007d-6c25-41ad-a357-2af144967c7c.png" alt="Futuristic digital network connections illustrating technology and innovation" loading="lazy" />
      </div>
      <div class="col-md-7" id="about-us-content">
        <h4>Transforming Brands Through Innovation & Technology</h4>
        <p>If you are right now on a journey of digital transformation, you need to collaborate with a visionary business
          ...
          Xeroic is poised on a journey of digital innovation and excellence, transforming your business by leveraging
  ...
  <section id="about" class="container d-lg-flex align-items-center justify-content-between gap-5">
    <div class="about-images position-relative flex-shrink-0 mb-4 mb-lg-0">
      <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/67f97a22-7740-40ee-a9cb-9381243ef4b0.png"
        ...
        class="top-image shadow-lg" loading="lazy" onerror="this.onerror=null;this.src='https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/acd9b909-8b5c-4083-9359-4b811893fd65.png'"/>
      <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/e9d6cf01-316b-4b2d-8cb7-3f5bd50194b7.png"
        ...
        class="bottom-image shadow-lg" loading="lazy" onerror="this.onerror=null;this.src='https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/74da3e98-8230-4027-8c21-cf5cb803dd4b.png'"/>
    </div>
    <div class="about-content flex-grow-1">
      ...
      <p class="lead text-muted mb-4">If you are going to use a passage of Lorem Ipsum, you need to be
        sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the internet tend to repeat predefined chunks as necessary, making this the first true generator.
        If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the internet tend to repeat predefined chunks as necessary, making this the the true generator.</p>
...
<section id="technologies" aria-label="Technologies behind your success">
  ...
  <div class="tech-carousel-container">
    <div class="tech-carousel-track">
      <!-- Original set -->
      <img src="IMAGE1.png" alt="PHP logo" />
      <img src="IMAGE2.png" alt="Node.js logo" />
      <img src="IMAGE3.png" alt="Python logo" />
      <img src="IMAGE4.png" alt="React logo" />
      <img src="IMAGE5.png" alt="Shopify logo" />
      <img src="IMAGE6.png" alt="Google Cloud logo" />
      <img src="IMAGE7.png" alt="Flutter logo" />
      <img src="IMAGE8.png" alt="WordPress logo" />
  ...
  <section id="marketing-services" aria-label="Best Digital Marketing Services">
    <div class="container">
      ...
      <button class="btn btn-discover" type="button" aria-label="Discover more digital marketing services">Discover More
      </button>
    </div>
  </section>
  {{-- <!-- Best Digital Marketing Services -->
  <section id="best-marketing" class="text-center">
    <div class="container">
      ...
      <p class="description mx-auto">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the internet tend to repeat</p>
      <div class="row g-4 justify-content-center">
        <div class="col-md-2 col-6">
          <div class="card">
            <i class="fa-solid fa-code card-icon"></i>
            <h5 class="mb-2">Website Development</h5>
            <p class="small">When an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
          </div>
        </div>
        <div class="col-md-2 col-6">
  ...
  <section id="why-choose">
    <div class="container">
      ...
      <p class="subheading">Tapworx integrates advanced IT solutions and data-driven marketing strategies to solve complex business challenges and fuel sustainable growth.</p>
      <div class="dotted-line"></div>
      <div class="why-cards">
        <div class="why-card">
          <i class="fa-solid fa-gears"></i>
          <h5>Cutting-Edge Tools & Techniques</h5>
          <p>We've delivered measurable success for startups, enterprises, and everything in between – helping brands grow, scale, and lead in the digital space.</p>
        </div>
  ...
  <section id="client-feedback">
    <div class="container">
      ...
      <h4>About Working With Us</h4>
      <div class="testimonial-slide" id="testimonial-slide">
        <p>Randomised words whdon’t look even slightly believable. If you are going to use ssage of Lorem ipsum, you.</p>
        <div class="client-info">
          <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/4c2ce62a-1e04-4804-a831-5f86a6a926d9.png"
            alt="Portrait of Steven Nelson, client testimonial avatar with short haircut and beard, smiling" />
          <div>
            Steven Nelson<br /><small>Designer</small>
          </div>
        </div>
      </div>
      <div id="client-feedback-carousel-indicators" class="mt-3">
        <button class="active" aria-label="Testimonial 1" data-index="0"></button>
        <button aria-label="Testimonial 2" data-index="1"></button>
        <button aria-label="Testimonial 3" data-index="2"></button>
      </div>
    </div>
  </section>
  ...
  <section id="latest-blog">
    <div class="container">
      ...
      <p class="subheading">Discover how digital agencies work hand-in-hand to setting up e-commerce platforms for online selling</p>
      <div class="row g-4 justify-content-center">
        <div class="col-md-4 col-sm-6">
          <div class="blog-card">
            <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/384098d0-85e4-4514-8c72-aa4bdbdb8164.png"
              alt="Colorful digital illustration showing an envelope surrounded by clouds, eyes and mail icons" loading="lazy"
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-card">
            <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/ead73579-69e3-47b7-b90f-7a588ed6afdf.png"
              alt="Illustrative vector image of a businessman using cloud computing services with document icons around" loading="lazy"
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-card">
            <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/15db0665-7f68-464c-aa84-97e3836065b2.png"
              alt="Vibrant digital marketing ecommerce concept with shopping carts, gifts and digital icons" loading="lazy"
              onerror="this.onerror=null;this.src='https://placehold.co/600x400?text=Image+not+available'"/>
            <div class="blog-card-body">
              <div class="blog-meta">27 August | comment</div>
              <h5 class="blog-title">Representation on Digital platforms.</h5>
 ...
 <!-- Email Newsletter -->
  <section id="email-newsletter" aria-label="Subscribe to email newsletter">
    <div class="container">
      ...
      <form aria-label="Subscribe to newsletter form" onsubmit="event.preventDefault(); alert('Thank you for subscribing!');">
